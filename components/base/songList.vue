<template>
  <div
    class="flex max-h-[calc(100dvh-138px)] overflow-scroll flex-col p-2 border rounded-lg scPage scBackground border-zinc-700">
    ...
    <div v-if="activeTab === 'mySongs'">
      <div
        @click="goToSong(song.uuid)"
        class="flex items-center gap-2 p-2 transition-all duration-200 scBorder scRounded bg-white/5 hover:bg-white/10 hover:cursor-pointer"
    ...
    <div v-if="activeTab === 'topSongs'">
      <div
        class="flex items-center gap-2 p-2 scBorder scRounded bg-white/5"
